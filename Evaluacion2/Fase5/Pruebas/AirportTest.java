...
public class AirportTest {
    ...
    class EconomyFlightTest {
        ...
        class RegularPassenger {
            //completar esto en el ejercicio 8
            @Test
            ...
            public void testEconomyFlightRegularPassengerAddedOnlyOnce(RepetitionInfo repetitionInfo) {
                ...
                assertAll("Verifica que un pasajero Regular se pueda agregar a un vuelo económico mas una vez",
                        () -> assertEquals(1, economyFlight.getPassengersSet().size()),
    ...
    class BusinessFlightTest {
        ...
        @Nested
        @DisplayName("Cuando tenemos un pasajero regular")
        class BusinessRegularPassenger {
            @Test
